...
public class Conc_Event {
    ...
    public Conc_Event(String eId, String eName, String eDate, long eSecond, String eDuration, String club, String eVenue, String eDisc, long eExpenses, String eSummary) {
        this.eId = eId;
        this.eName = eName;
        this.eDate = eDate;
